...
class ServerApp:
    ...
    def accept_clients(self):
        while True:
            ...
            thread = threading.Thread(target=self.handle, args=(client,self.path))
            thread.start()
                    ...
                    if message:
                        try:
                            with open(full_path, 'wb') as file:
                                ...
                                self.conversation_text.insert(tkinter.END, f"File received and saved to {path}\n")
    ...
    # def receive_file(self, client, file_path):
        ...
        #             file.write(chunk)
        #         self.conversation_text.config(state='normal')
        #         self.conversation_text.insert(tkinter.END, f"File received and saved to {file_path}\n")
        #         self.conversation_text.config(state='disabled')
        # except Exception as e:
        #     print(f"Error receiving file: {e}")
    #     return
